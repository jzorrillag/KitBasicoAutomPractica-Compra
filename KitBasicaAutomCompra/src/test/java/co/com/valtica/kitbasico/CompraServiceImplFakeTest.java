...
@SpringBootTest(classes = { PolizaRepositoryFake.class, GobiernoRepositoryFake.class, AseguradoRepositoryFake.class,
		VehiculoRepositoryFake.class, CompraServiceImpl.class })
